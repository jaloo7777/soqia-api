...
exports.logOut = asyncHandler( async (req,res,next) => {
  // we will clear the cookie with the logOut
...
exports.forgotPassword = asyncHandler( async (req,res,next) => {
    ...
    const message = ` You are receiving this email cuz you (or someone else) has requested the reset of a 
  ...
  await user.save({validateBeforeSave: false})  // doing this if we dont want to run any validators
